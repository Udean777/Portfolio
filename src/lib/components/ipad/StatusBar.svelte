...
<style>
	...
	/* Light mode styles */
	:global(.mac-light) .ipad-statusbar {
		color: rgba(0, 0, 0, 0.88);
	}
	:global(.mac-light) .ipad-statusbar .battery-body {
		border-color: rgba(0, 0, 0, 0.7);
	}
	:global(.mac-light) .ipad-statusbar .battery-fill {
		background: rgba(0, 0, 0, 0.8);
	}
	:global(.mac-light) .ipad-statusbar .battery-tip {
