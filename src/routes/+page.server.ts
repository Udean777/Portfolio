...
export const load: PageServerLoad = async () => {
	return {
		meta: {
			...
			description:
				"Sajudin Ma'ruf is a Frontend and Mobile Developer in Indonesia building responsive web experiences and useful apps with SvelteKit, Flutter, and React Native.",
			url: `${SITE_URL}/`,
